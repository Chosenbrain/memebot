...
async function isHoneypot(tokenAddress) {
  try {
    ...
    const buyParams = { tokenIn: WETH, tokenOut: tokenAddress, fee: 3000, recipient, deadline, amountIn, amountOutMinimum: 0, sqrtPriceLimitX96: 0 };
    const buyOut = await router.callStatic.exactInputSingle(buyParams, { value: amountIn, gasLimit: 300000 });
    const sellParams = { tokenIn: tokenAddress, tokenOut: WETH, fee: 3000, recipient, deadline, amountIn: buyOut, amountOutMinimum: 0, sqrtPriceLimitX96: 0 };
